...
config1 = "data/ner/conll2003_AGN_ae_sigmoid.json"
config2 = "data/ner/conll2003_AGN_vae_sigmoid.json"
config = config1
...
for valve in range(0, 55, 5):
    ...
    os.system(f"python run_ner.py --ae_epochs 100 --epochs 100 --config {config} --valve_rate_sigmoid {valve_rate} ")
    print()
